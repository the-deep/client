...
import SourcesFilter, { useFilterState, getProjectSourcesQueryVariables } from '#components/leadFilters/SourcesFilter';
...
import {
    ...
    SortDirection,
} from '#components/leadFilters/SourcesFilter/utils';

...
const entries = [
    {
        leadTitle: 'The standard Lorem Ipsum passage, used since the 1500s',
        leadCreatedOn: '2020-10-12',
    ...
    {
        leadTitle: 'Section 1.10.32 of "de Finibus Bonorum et Malorum", written by Cicero in 45 BC',
        leadCreatedOn: '2021-03-11',
...
function SourcesGrid(props: Props) {
    ...
    return (
        <div className={_cs(styles.sourcesGrid, className)}>
            {entries.map((entry) => (
                <EntryCard
                    leadTitle={entry.leadTitle}
                    leadCreatedOn={entry.leadCreatedOn}

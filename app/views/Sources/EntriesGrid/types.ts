...
type Project = NonNullable<ProjectEntriesQuery['project']>;
type ProjectForFramework = NonNullable<ProjectFrameworkForCardsQuery['project']>;
...
export type FrameworkRaw = DeepMandatory<NonNullable<ProjectForFramework['analysisFramework']>, 'key'>;

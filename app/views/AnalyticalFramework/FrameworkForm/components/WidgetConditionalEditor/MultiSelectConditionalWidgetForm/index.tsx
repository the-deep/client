...
import SimpleMultiSelectConditionInput from './SimpleMultiSelectConditionInput';

import styles from './styles.css';

interface Option {
    key: MultiSelectCondition['operator'],
    label: string,
    invertedLabel: string,
}

const options: Option[] = [
    { key: 'multi-selection-selected', label: 'Is selected', invertedLabel: 'Is not selected' },
...
type FormType = MultiSelectConditional;
...
const conditionSchema: ConditionSchema = {
    fields: (val): ConditionSchemaFields => {
        ...
        if (
            val.operator === 'multi-selection-selected'
        ) {
            return {
                ...basicValidation,
...
function ConditionInput(props: ConditionInputProps) {
    ...
    return (
        ...
        >
            ...
            />
            {(
                value.operator === 'multi-selection-selected'
            ) && (
                <SimpleMultiSelectConditionInput
                    index={index}
                    value={value}
...
interface MultiSelectConditionalWidgetFormProps {
    onCancel: () => void;
...
function MultiSelectConditionalWidgetForm(props: MultiSelectConditionalWidgetFormProps) {
    const {
        onSave,
        onCancel,
        initialValue,
...
export default MultiSelectConditionalWidgetForm;

...
interface Option {
    key: DateCondition['operator'],
    label: string,
    invertedLabel: string,
}

const options: Option[] = [
    { key: 'date-after', label: 'Is after', invertedLabel: 'Is not after' },
    { key: 'date-before', label: 'Is before', invertedLabel: 'Is not before' },
    { key: 'date-equal-to', label: 'Is equal to', invertedLabel: 'Is not equal to' },
...
const conditionSchema: ConditionSchema = {
    fields: (val): ConditionSchemaFields => {
        ...
        if (
            val.operator === 'date-after'
            || val.operator === 'date-before'
            || val.operator === 'date-equal-to'
        ) {
            return {
                ...basicValidation,
...
function ConditionInput(props: ConditionInputProps) {
    ...
    return (
        ...
        >
            ...
            />
            {(
                value.operator === 'date-after'
                || value.operator === 'date-before'
                || value.operator === 'date-equal-to'
            ) && (
...
interface DateConditionalWidgetFormProps {
    onCancel: () => void;
...
function DateConditionalWidgetForm(props: DateConditionalWidgetFormProps) {
    const {
        onSave,
        onCancel,
        initialValue,
...
export default DateConditionalWidgetForm;

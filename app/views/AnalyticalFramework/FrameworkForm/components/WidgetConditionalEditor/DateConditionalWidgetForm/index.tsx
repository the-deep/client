...
const options: Option[] = [
    { key: 'date-after', label: 'After', invertedLabel: 'Not after' },
    { key: 'date-before', label: 'Before', invertedLabel: 'Not before' },
    { key: 'date-equal-to', label: 'Equal to', invertedLabel: 'Not equal to' },

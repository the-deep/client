...
interface Option {
    key: OrganigramCondition['operator'],
    label: string,
...
type FormType = OrganigramConditional;
...
const conditionSchema: ConditionSchema = {
    fields: (val): ConditionSchemaFields => {
        ...
        if (
            val.operator === 'organigram-selected'
        ) {
            return {
                ...basicValidation,
...
function ConditionInput(props: ConditionInputProps) {
    ...
    return (
        ...
        >
            ...
            />
            {(
                value.operator === 'organigram-selected'
            ) && (
                <SimpleOrganigramConditionInput
                    index={index}
                    value={value}
...
interface OrganigramConditionalWidgetFormProps {
    onCancel: () => void;
...
function OrganigramConditionalWidgetForm(props: OrganigramConditionalWidgetFormProps) {
    const {
        onSave,
        onCancel,
        initialValue,
...
export default OrganigramConditionalWidgetForm;

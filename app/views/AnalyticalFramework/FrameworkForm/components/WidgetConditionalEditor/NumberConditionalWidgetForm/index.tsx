...
import SimpleNumberConditionInput from './SimpleNumberConditionInput';

import styles from './styles.css';

interface Option {
    key: NumberCondition['operator'],
    label: string,
...
type FormType = NumberConditional;
...
const conditionSchema: ConditionSchema = {
    fields: (val): ConditionSchemaFields => {
        ...
        if (
            val.operator === 'number-greater-than'
            || val.operator === 'number-less-than'
            || val.operator === 'number-equal-to'
        ) {
            return {
                ...basicValidation,
...
function ConditionInput(props: ConditionInputProps) {
    ...
    return (
        ...
        >
            ...
            />
            {(
                value.operator === 'number-greater-than'
                || value.operator === 'number-less-than'
                || value.operator === 'number-equal-to'
            ) && (
                <SimpleNumberConditionInput
                    index={index}
                    value={value}
...
interface NumberConditionalWidgetFormProps {
    onCancel: () => void;
...
function NumberConditionalWidgetForm(props: NumberConditionalWidgetFormProps) {
    const {
        onSave,
        onCancel,
        initialValue,
...
export default NumberConditionalWidgetForm;

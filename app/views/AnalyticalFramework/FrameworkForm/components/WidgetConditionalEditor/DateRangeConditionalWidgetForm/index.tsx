...
import SimpleDateRangeConditionInput from './SimpleDateRangeConditionInput';

import styles from './styles.css';

interface Option {
    key: DateRangeCondition['operator'],
    label: string,
...
type FormType = DateRangeConditional;
...
const conditionSchema: ConditionSchema = {
    fields: (val): ConditionSchemaFields => {
        ...
        if (
            val.operator === 'date-range-after'
            || val.operator === 'date-range-before'
            || val.operator === 'date-range-includes'
        ) {
            return {
                ...basicValidation,
...
function ConditionInput(props: ConditionInputProps) {
    ...
    return (
        ...
        >
            ...
            />
            {(
                value.operator === 'date-range-after'
                || value.operator === 'date-range-before'
                || value.operator === 'date-range-includes'
            ) && (
                <SimpleDateRangeConditionInput
                    index={index}
                    value={value}
...
interface DateRangeConditionalWidgetFormProps {
    onCancel: () => void;
...
function DateRangeConditionalWidgetForm(props: DateRangeConditionalWidgetFormProps) {
    const {
        onSave,
        onCancel,
        initialValue,
...
export default DateRangeConditionalWidgetForm;

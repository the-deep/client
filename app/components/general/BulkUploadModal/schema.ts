...
type Lead = EnumFix<LeadInputType, 'priority' | 'confidentiality'>;
...
type LeadFormSchema = ObjectSchema<PartialLeadType, PartialFormType>;
type LeadFormSchemaFields = ReturnType<LeadFormSchema['fields']>;

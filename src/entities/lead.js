        ...
        switch (key) {
            case 'created_at':
                if (filter) {
                    ...
                    leadsFilter.created_at__gte = getDateWithTimezone(filter.startDate);
                    leadsFilter.created_at__lt = getDateWithTimezone(encodeDate(endDate));
                }
                break;
            case 'published_on':
                if (filter) {
                    ...
                    leadsFilter.published_on__gte = filter.startDate;
                    leadsFilter.published_on__lt = encodeDate(endDate);
                }
                break;
            case 'entries_filter':
